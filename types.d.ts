 ...
 */
declare type mainFunction = (_?: any, config: any, meta: any)=>void;
...
declare interface Http {
     ...
     * });
     */
    simpleRequest(config: any, config.method?: string, config.url: string, config.timeout?: number, config.body?: string, config.headers?: any, callback: any): void;
}
...
declare interface Net {
     ...
     */
    connect(params: ConnectParams, callback: connectCallback): NetClient;
}
...
declare interface DBConn {
     ...
     */
    query(queryString: string, parameter1: any, parameter2: any, callback: queryCallback): void;
    /**
     ...
     * @param {function} [callback]
     */
    exec(queryString: string, parameter1?: any, parameter2?: any, callback?: any): void;
}
...
declare module 'DBConn' {
     ...
     * @param {object[]} [result]
     */
    declare type queryCallback = (error?: string, result?: any[])=>void;
...
declare module 'Net' {
     ...
     * @param {string} [error]
     */
    declare type connectCallback = (error?: string)=>void;
...
declare module 'Http' {
     ...
     */
    declare type simpleRequestCallback = (error?: string, response?: any, response.data: Bytes, response.headers: any, response.status: string, response.statusCode: number)=>void;
